...
> **Version 4 · 2026-09-02 · supersedes v3 (2026-09-02)**
> *Changed in this version:* four corrections, no new content.
> **(1)** §7 said "there is no rung numbering," contradicting §10, which withdrew that ruling — corrected.
> **(2)** Pipeline rule 10 told you to add words to "the negative block," contradicting rule 13, which says
> there is no negative field — rewritten in positive form.
> **(3)** §3 listed the reference crops twice, in two places, with different contents — merged into one
> list, and `pim-crop.png`, `yolanda-crop.png` and `fig-crop.png`, which the file claimed existed but did
> not, have now been cut from the Episode 001 art and do exist.
> **(4)** Added a **proposed** token block for Old Ambrose, so the §3 gap has something to approve rather
> than a blank.
>
