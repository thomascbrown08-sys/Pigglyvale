# The Pigglyvale Series Bible

> **Version 7 · 2026-09-05 · supersedes v6 (2026-09-05)**
> *Changed in this version:* **the theft double-booking is resolved and the Watch's name is settled.**
> **(1)** §10 — the theft thread closed: one thread across two seasons rather than two episodes competing
> for one plot. Three guards, restitution rather than punishment, Bruno placed third or fourth on the bench.
> **(2)** §10 — *"The Watch" as a name* closed by consequence. Protective. The name stands and the
> find-and-replace is retired.
> **(3)** §9 — the reader-requested theft episode note rewritten to point at the ruling.
> **(4)** Full working in `docs/the-arc-room_v3.md` under *Arc A · The theft thread*.
>
> *Carried unchanged from v6:* **the art gap is closed.** Everything below v6's header is addition, not
> correction.
> **(1)** §3 — approved appearance token blocks for **Bruno "Buckets" Marrow** and **Gus Thornapple**, with
> design reasoning, the species trap on each, and the scale sentence each needs in shared frames.
> **(2)** §3 — Bruno's tail tell and Gus's cap, added to their character notes as prose tells.
> **(3)** §11 rewritten: the token half of the block is discharged; only the sheets remain, and they are now
> in `prompts/ART-QUEUE.md` §1 as rollable items rather than in §3 BLOCKED.
> **(4)** §5b — pipeline rule 22, on species names that summon the wrong animal entirely.
>
> **Filename carries the version; so does this block.** If the filename is ever stripped by a download or an
> upload, this header is the fallback. Check the version and date here before working from any copy.

**This file is data, not instructions.** It is the single source of truth for continuity. Paste it (or point
to it) at the start of any session that writes an episode. Update it *after* every episode ships.

---

## 1. The Premise in One Line

A small kingdom run mostly out of its kitchen, where nobody is a villain, everybody is wrong sometimes, and
the apologies are real.

---

## 2. Principals

### Princess Carolyn of Pigglyvale
...
**Her flaw — virtue overshooting.** She says yes too fast. She'd rather absorb a cost than watch someone be
disappointed. She keeps the peace at her own expense, does not mention the expense, and then goes uncharacteristically
sharp when the bill finally comes due — which makes *her* look like the problem, when the real problem was
three weeks of unspoken yeses.

**Hard rules:**
- She is never humiliated, never stupid, and never the butt of a joke about her competence or her looks.
- Her mistakes are always *legible as virtue* to a sympathetic reader.
- She gets to be right about things. Often. She is a good ruler having a hard week, not a mess being managed.

### Thomas the Drake of Snouton, Storykeeper and Master of Lessons
...
**His flaw — he fixes.** He steps in. He solves it *for* her, which quietly tells her she couldn't have.
He reaches the moral before he has finished listening. He is occasionally certain and wrong, and being
certain is what makes him wrong.

**Hard rule:** Thomas apologizes on the page, out loud, with the parts named, at least once every three or
four episodes — and at least once he must be corrected inside his own Advisor's Notes and say so in the next
episode's Notes. He is not the sage. He is the guy holding the book.

**Running joke:** He is a duck. Snouton is named for snouts. Nobody can explain this, including him, and he
becomes visibly uncomfortable when asked.

---

## 3. Recurring Townsfolk

Each carries one **harm engine** (see the skill file). Rotate them; don't let one dominate.

| Name | Species | Engine | Note |
|---|---|---|---|
| **Miss Delphine Quill** | hedgehog | *Rule over person* | Keeps Pigglyvale's records, ledgers, and rules. Order once saved her when nothing else did — reveal this slowly, maybe season two. Dry, exact, and secretly desperate to be invited to things. |
| **Auntie Yolanda Plum** | goose | *Good intention, bad execution* | Runs the pepper-and-spice stall at Marketrow. Cooks like weather. Will reorganize your kitchen because she loves you. Loud, generous, listens poorly. |
| **Bruno "Buckets" Marrow** | otter | *Shortsighted self-interest* | Young, charming, always has a cart and a scheme. Never malicious. Never looks past next Tuesday. The engine behind most second-order-effect episodes. |
...
> out of the plum-and-mango palette without competing with Marisol's indigo. The hat pushed back off the
...
**Bruno "Buckets" Marrow — approved 2026-09-05. Canon. Sheet still to be rolled.**

- **Bruno "Buckets" Marrow:** a young adult anthropomorphic otter, plainly a grown man and not a boy, with a
  long supple body and a loose easy stance; dense sleek fur in warm dark chestnut brown, a pale cream throat
  and chin running down under the jaw, a broad flat muzzle with thick pale whiskers, small round ears set low
  and close against the head, bright black eyes; a thick tapering tail nearly as long as his body, held clear
  of the ground; a worn brick-red canvas waistcoat with brass buttons and one button missing, worn over bare
  arms, cuffed canvas trousers rolled to the knee, a faded teal neckerchief loose at his throat, and bare
  webbed feet; lean, quick, and entirely at his ease

> *Design reasoning, so it can be argued with: every settled silhouette on this site is at rest — Quill
> vertical and closed, Ambrose horizontal and unhurried, Marisol sturdy, Carolyn short and round, Gus braced.
> Bruno is the only one built for speed, and the otter body gives it free. The tail carries most of the
> silhouette, so it is specified as nearly body-length and held clear of the ground; left unstated the tool
> returns a stumpy beaver tail or drops it. The waistcoat was expensive once and he is not its first owner,
> and one button is gone — which is the whole character in one reproducible shape. Brick-red and teal are
> chosen because they are the two notes nobody else has: plum and mango are Carolyn's, indigo and oatmeal
> Marisol's, olive and straw Ambrose's, plum-grey Quill's. Brick-red sits near Yolanda's scarlet in hue and
> nowhere near it in value — hers is bright and small, his is dull and large. **No hat, deliberately:**
> Ambrose has the straw brim and Gus has the cloth cap, and three hats in a cast this size reads as a
> costume department.*

> **Bruno has no shoes and never will.** Bare webbed feet. Write him inside it, the way Thomas is written
> inside having no hands.
>
> **His tell is the tail, and no still image can carry it** — so it lives here rather than in a prompt:
> **the tail stops moving when he is actually thinking, and the rest of the time it is going.** Same class of
> tell as Thomas's crest feathers. Usable in prose, never in an image slot.

> **Scale, which a solo sheet cannot hold (rule 18).** *He stands a little taller than the princess and about
> half her width.* Taller and much narrower is the entire read. **State it in the composition block of every
> shared frame** — left alone the model makes him short and round, because it has Carolyn.


**Gus Thornapple — approved 2026-09-05. Canon. Sheet still to be rolled.**

- **Gus Thornapple:** an elderly anthropomorphic pig man, heavy and thickset, with a short powerful neck and
  shoulders set forward so that his head is carried low and slightly ahead of him; coarse bristly hide in
  grizzled iron-grey shot through with brown, paler and almost white along the jaw, a broad blunt snout,
  small deep-set dark eyes under heavy brows, one ear notched through at the top and healed long ago, two
  short worn lower tusks; a dark moss-green shirt with the sleeves rolled past the elbow, a heavy
  oiled-leather work apron to the knee, thick earth-brown canvas trousers, wide scuffed boots, a broad
  cracked leather belt, and a flat dark cloth cap pulled low over the eyes; braced, weathered, and looking at
  something off to one side

> *Design reasoning, so it can be argued with: **the cap is the argument.** Ambrose's brim is pushed back off
> his face because the one thing he is for is looking at somebody steadily while they work out they were
> wrong. Gus's cap is pulled low and he is looking off to one side — the same garment class carrying exactly
> the opposite meaning, because the man who knows a week early and tells you a week late does not deliver it
> to your face. That reads in a still frame, which is the test. **Tusks and the notched ear exist to separate
> him from the crowd**: Pigglyvale defaults to pig and every other named pig is a sow or a piglet, so the
> first named old male pig needs features the crowd does not have or he dissolves into it. Both marks are
> history rather than menace — he grumbles, he is not dangerous. Iron-grey shot with brown and a near-white
> jaw sits clear of Marisol's dusty rose-grey and Carolyn's warm caramel, and the coarse bristly texture
> separates him as much as the colour does.*

> **The distinction most worth checking on the first roll: Ambrose is *settled*, Gus is *braced*.** Both are
> low and horizontal and they could collide. Ambrose's dome is at rest with nothing coming; Gus's wedge has
> its weight forward, as though about to lean on something or push it. **If a roll comes back and you cannot
> tell the two of them apart from the shoulders alone, the block needs another pass.**

> **Scale.** *He stands about a head taller than the princess and half again her width through the
> shoulders.* State it in every shared frame.
...
> then roll a sheet, **before** he appears in a frame. Pipeline rule 16 is unambiguous: a character named in
> a slot with nothing attached comes back as the wrong species.

### Reference crops — the full list

Every one of these exists in `images/_reference/` and has been checked. **Attach the relevant crop to every
slot the character appears in** (pipeline rule 16) until a proper sheet replaces it.

| Crop | Cut from | Shows |
|---|---|---|
| `pim-crop.png` | Ep. 001 `03-beat` | Full figure on the step stool, apron, tail. |
| `yolanda-crop.png` | Ep. 001 `02-beat` | Full figure, wings spread, scarlet headwrap, stained apron. |
| `fig-crop.png` | Ep. 001 `04-beat` | Full figure in the doorway, grey eye patch, egg basket. |
| `marisol-crop.png` | Ep. 002 hero attempt | Full figure, headwrap, striped shirt, oatmeal smock. |
| `quill-crop.png` | Ep. 002 `03-beat` | Full figure standing, basket, whole silhouette. |
| `quill-face-crop.png` | Ep. 002 `05-repair` | Seated and close; use when the face matters. |

*v3 of this file listed the first three as existing when they did not. They were cut from the Episode 001
art on 2026-09-02 and are now real. **Old Ambrose still has no crop**, because he has never been drawn.*
...
- **Pigglyvale** — the kingdom. Small. Walkable. One good road.
- **The Kitchen Royal** — where most of the ruling actually happens.
- **The Long Table** — the courtyard table where the kingdom eats together. Most episodes end here.
- **Marketrow** — stalls, carts, arguments, the best smells in the kingdom.
- **The Pepper Patch** — shared ground, tended by everyone, which means tended by no one. Load-bearing for
  the economics track.
- **The Bramble** — the wild edge of things. Where you go to be alone or to lose something.
- **Snouton** — over the ridge. Thomas's home. Confusingly named.

**Cuisine:** Soul, Caribbean, and Hispanic cooking, treated with real affection and real specificity —
...
Paste this block at the top of **every** image prompt, unchanged, forever. Drift in the art is the fastest
way to make the site look amateur.
...
10. **The model reads a small character as a child.** Miss Quill came back looking about six. Stating that
   ...
   the princess's shoulder, roughly two-thirds her height* — and say it positively: *a grown woman at full
   adult proportion, a broad settled body, short limbs, a lined face, and she carries herself very upright.*
   *(Corrected in v4: this rule used to say "add child, little girl, doll to the negative block," which
   contradicts rule 13. There is no negative block. Naming "child" would draw one.)*
...
22. **Some species names summon a different animal entirely, and the fix is the noun rather than the
   adjectives.** *Boar* returns a feral wild boar — bristled, four-legged, out of a different book — no
   matter what is written around it. Gus's block therefore leads with *an elderly anthropomorphic pig man*
   and demotes the tusks and bristles to individual features. Same family as rule 17, but one level up: rule
   17 is about describing a species in shape terms, this is about the species word itself being wrong.
   Check the head noun before adding detail to it.
21. **A character can be in the prose and out of the art, and this is the correct handling.** Gus Thornapple
   is in three scenes of Episode 003 and is named in none of its image slots, because he has no token block
   and no reference. Rule 16 says a named character with nothing attached comes back as the wrong species,
   so the choice is not *name him and hope* — it is *write the crowd generically and roll him later*. Slot
   03 of `prompts/ep-003-prompts.md` is the worked example: eight or nine unnamed pigs described by shape
   and clothing, no individual identified. The story loses nothing. Do this rather than delaying an episode.

---

## 6. Episode Ledger

Update after every episode. This is what keeps the teaching balanced and the callbacks accurate.
...
| 003 | *Quantity Not Stated* | Conflict resolution: saying the expectation out loud | Second-order thinking (the written rule is not the mechanism; the saying-aloud is) | Good intention, bad execution (Yolanda), and the **same engine repeated through Thomas** in a nicer register | **Carolyn** to Yolanda, three parts; **Yolanda** to Carolyn, and she pays it — a walk up Marketrow un-promising sixty jars one household at a time; **Thomas** owns the Ambrose correction at the head of the Notes | The grant rule rewritten and signed; Yolanda's *of course*; Thomas's memorandum; **butterflies deliberately withheld** — first episode with none, so that they are visibly not a fixture; Ambrose kept off the page by choice, not by lack of a sheet |

## 6b. The Season Clock

*Kept separate from the ledger above rather than added as two more columns, because the ledger already runs
seven wide and a nine-column table stops being read. Same function; fill in after each episode ships.*

**Latency** is the lag between the flaw firing and the character catching it. It is logged **retroactively**
— write the episode the story wants, then record where they landed. Never plan the ladder forward. Full
machinery in `the-arc-room_v2.md` §4.

| # | Carolyn — catches the yes | Thomas — asks *"did she ask you to?"* | Season thread touched |
|---|---|---|---|
| 001 | three weeks | a four-year-old had to ask it for him | both opened |
| 002 | three weeks (the flare arrives late and lands on Quill) | — (he is wrong without carrying the repair; corrected by Ambrose, not yet owned) | Carolyn |
| 003 | **twelve days — and the shape of the lag has changed.** She had the correct number in four seconds on the second afternoon. What she did not do for twelve days was *say* it. The gap has moved off noticing and onto speaking, which is where it now lives. | **after he had already done the thing, and nobody had to ask him.** He wrote the memorandum unasked, handed it to both parties, and caught it himself. Ep. 001 needed a four-year-old. | Thomas advances; **Carolyn holds** |

---

## 7. Established Facts

*(Add one line per fact the moment it hits the page. Names, foods, weather, who is related to whom, what
color the kitchen door is. Future-you will need every one of these.)*
...
- **The Keep, outermost to innermost:** 6 the Road · 5 Marketrow · 4 the Great Hall · 3 the Inner Court ·
  ...
  the seat, conduct keeps the keys.* **Outward** movement has five numbered rungs (notice it · name it small
  and early · adjust one key · step them out one ring and say so · set the Watch) and may be cited by number.
  **Inward** movement has four things worth counting (time under weather · small things repeatedly · how they
  take a no · what repair looks like when they fail) and is always described in plain words, never numbered.
...
- **Miss Quill's rewritten grant rule, in full.** Four lines: *What is being made. How much of it. Who it is
  for. When it stops.* Both parties fill it in **together, at the start, out loud**, and the writing is what
  is left over afterwards. The seven days' notice is abolished. It takes four minutes. Signed at the Long
  Table with the lines read aloud, and Miss Quill ruled a line under it. **This closes the open thread that
  said the rule should appear on the page rather than be mentioned.**
- **Between Carolyn and Auntie Yolanda, *of course* has always meant *yes, all of it, obviously, do not
  insult me by asking twice*.** Thirty years of it. It is the two words Carolyn also gave Yolanda in
  Episode 001, and neither of them has ever noticed.
- **Auntie Yolanda fills in the half that was not said**, and has done for thirty years, and has never once
  called it making things up. She said this out loud, about herself, on the kitchen step.
- **The pepper harvest** comes in during the third week of cold nights. Yolanda's crop was eleven bushels
  with Gus's. Forty-four jars came out of it; sixty had been promised.
- **Pigglyvale's pique** — vinegar, small hot peppers, garlic, oregano, peppercorns, a little honey — is the
  kingdom's winter sauce, made in the Kitchen Royal and topped up with vinegar for a year.
- **Beatrix Hollyhock's big oven is repaired**, and she came to the Long Table with her own bread for the
  first time since the summer. Gus said three weeks and it was ten. Nobody has mentioned this to Gus.
- **Thomas cannot carry two of anything**, so when he needs a thing delivered twice, Pim runs it. Established
  by the memorandum.
- **Auntie Yolanda rehangs a spoon rack handle inward** when she is improving somebody's kitchen. Pim turns
  her own spoon back and does not touch the others, because they are not hers to turn.
- **The Kitchen Royal doorstep** is stone, whitewashed wall behind, and is where the hard conversation
  happens when the kitchen is too full of peppers to have it indoors.

---

## 8. Running Gags

*(Seed list — grow it. Gags are how a series stops feeling like a collection.)*
...
- Bruno's cart name is a longer game than anybody realises (*MARROW & DAUGHTERS*; there are no daughters).
  Ep. 003: *MARROW & DAUGHTERS, PURVEYORS* — purveyors of what to be established by Tuesday.
...
- Gus retreating behind a wall when he is pleased. Ep. 003: he had been told at length by three separate
  people that he had been right, and had to go and stand behind one.
- **Gus knows a week early and mentions it a week late.** Now firmly a gag rather than a character note.
- **Thomas attempting the side door**, and attempting it again with a cart on the theory that a cart changes
  the geometry.
- **Miss Quill's four minutes.** *"Boring." / "Yes. That is what it is for."*
...
- **A thief.** An episode dealing with theft. **Settled 2026-09-05 and it is bigger than an episode.**
  It runs as **one thread across two seasons**: Episode 004 carries the offence, the unilateral pardon and
  the **withheld key**; the Season Two bench arc carries the reoffence, the hearing and the **restitution**.
  Bruno does not repent in 004 — which is why the reoffence undoes nothing, because nothing was resolved.
  Full ruling, the three guards and the register in `docs/the-arc-room_v3.md` under *Arc A · The theft
  thread*. See also §10.
...
A wing of the site, at `dojo/`. Full design rules in `docs/the-dojo-design.md`; the three that touch canon:

- **The Dojo is not canon.** Every case is a rehearsal. Characters put on a mask and act; nothing in a case
  happened, and nothing in a case enters the ledger or Established Facts. Bruno playing a manipulator does
  not make Bruno a manipulator — the tactic is the costume.
- **A mask is a rationalization**, not a personality: a sentence a person tells themselves so that what they
  are doing can keep feeling alright. It is a state, never an essence. Masks are never species-coded and
  never assigned to a permanent outsider class.
- **The Dojo names situations, sentences and masks. It never names the story's machinery.** No harm engines,
  no second-order thinking, no rung ladders. Those remain taught-by-plot only, per §5 and the skill file.
  This wing explains *conversations*, not the series.
...
- **The season spines are set.** Season One: Carolyn's yeses, with Thomas's *ask before you act* braided
  alongside — never resolved in the same episode. Season Two: the bench, Carolyn learning to hear, discern
  and apply. Machinery, cast assignments and the jurisdiction guard live in `the-arc-room_v2.md` §4.
- **The Season One plant for the bench arc** — one dispute resolved badly and quickly, two paragraphs, in the
  back half of an episode about something else. Nobody comments. Not yet assigned a host episode.
- ~~**Theft is double-booked.**~~ **Closed 2026-09-05, and it was a false conflict.** It is **one thread
  across two seasons**, not two episodes competing for one plot, and both bookings keep what they wanted.
  **004 · Arc A:** the offence, the unilateral pardon, and the key that is *not* given back. **Season Two ·
  the bench:** the reoffence, the hearing, and the restitution — with Bruno repenting a whole season late
  and paying it.
  **Three guards, and the first is the hinge.** *(1)* **004 must not restore the key** — forgive and hand
  access back, and the reoffence indicts Carolyn's judgment; forgive and set the Watch, and it vindicates
  her. Same events, opposite meaning, one beat. *(2)* The second offence is **the same engine in a new
  form**, never the same act again — a deposit he cannot cover, a thing not quite his to sell. Escalated by
  circumstance, not by character; Bruno is never malicious and this series has no villain. *(3)* **Bruno
  comes back**: the season ends with the repair he refused in 004, parts named and received.
  **The bench rules restitution, and the word *punishment* does not appear.** Scripture repairs theft by
  restoration — Zacchaeus restores fourfold before anybody asks him to. There is no jail in two hundred
  souls with one good road and there should not be. **Yolanda's walk up Marketrow un-promising sixty jars
  one household at a time is the register** — repair with a number on it.
  **Bruno is the bench arc's third or fourth case, never its opener.** A first case teaches the reader what
  a bench is and wants low stakes and a stranger. Full working: `docs/the-arc-room_v3.md`.
- ~~**Thomas owes the 002 correction.**~~ **Discharged in Episode 003**, at the head of the Advisor's Notes,
  in his own mouth and without Ambrose on the page. The second half of the every-three-or-four-episodes rule
  is now clear. **Next apology due from Thomas: 006 or 007** — he is not due in 004 or 005.
- ~~**Miss Quill's new grant rule.**~~ **On the page in Episode 003**, in full, and signed. See §7.
...
- **The two-hundred-word Pim beat** — Pim breaks something and starts quietly gathering her things, and
  Carolyn says: *"You don't lose your seat here. You might lose the spoon for a week."* **Not planted in
  003**, deliberately: 003 already carried a seat-versus-key beat in Yolanda's grant, and running both would
  have made the episode say one thing twice. **Now due in 004 or 005.**
- **Auntie Yolanda has named her own disposition out loud** — *I fill it in* — which is a season-length
  thing rather than an episode-length one. She should be seen *asking* at some point, in a small unremarked
  way, in an episode about something else. Do not narrate it and do not let anybody praise her for it.
...
- ~~**"The Watch" as a name.**~~ **Settled 2026-09-05, as a consequence of the theft ruling.** A bench that
  rules **restitution rather than punishment** makes the Watch unambiguously **protective**, which is what
  the word wants to mean. *The Gate* would have been needed only if the arc had gone punitive. **The name
  stands, and the find-and-replace that got more expensive every episode is retired.**
...
## 11. The art gap — half closed

**Both token blocks are written and approved (2026-09-05).** See §3. What is left is the rolling, and that
is now an ordinary queue item rather than a block on canon.

| | Owed | Blocks |
|---|---|---|
| **Bruno "Buckets" Marrow** | ~~token block~~ ✓ · `bruno-sheet.png`, then `bruno-portrait.png` | **Episode 004's art.** Not the script — 004 can be written against the approved tokens. |
| **Gus Thornapple** | ~~token block~~ ✓ · `gus-sheet.png` | Nothing. Three episodes in the prose, none in the art, and it was starting to show. |

**Roll the sheets before the episode art, not alongside it** (rule 9). Both are now `prompts/ART-QUEUE.md`
§1 items 3 and 4, written as self-contained paste blocks.

**Still with no tokens, and none of them blocking anything:** Beatrix Hollyhock, Donna, and the three
unnamed Bramblewicks (Dot, Sorrel, Bean). `ART-QUEUE.md` §3.

**Episode 004 now waits on one thing only: the theft double-booking** (§10). That is a story ruling and no
