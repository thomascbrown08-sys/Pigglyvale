...
## 1. TO ROLL — four, and two of them matter

**Items 3 and 4 are new (2026-09-05).** Bruno's and Gus's token blocks were approved that day, which moved
both of them out of §3 BLOCKED and into this queue. **Bruno is the priority** — he is the lead of Episode
004 and an episode cannot have its hero missing from its own hero shot. Items 1 and 2 block nothing.

**Suggested order: 3, then 1, then 4, then 2.**
...
### 3 · `bruno-sheet.png` — 16:9 — ***do this one first***
...
A character reference sheet. The same character drawn three times against a flat buttermilk background —
front view, three-quarter view, and side view — identical in costume and proportion across all three,
standing at rest, arms at his sides, hands empty, neutral expression. Nothing else is in the frame.

A young adult anthropomorphic otter, plainly a grown man and not a boy. A long supple body and a loose easy
stance. Dense sleek fur in warm dark chestnut brown, with a pale cream throat and chin running down under
the jaw. A broad flat muzzle with thick pale whiskers, small round ears set low and close against the head,
bright black eyes. A thick tapering tail nearly as long as his body, held clear of the ground and fully
visible in every view.

He wears a worn brick-red canvas waistcoat with brass buttons, one button missing, over bare arms; cuffed
canvas trousers rolled to the knee; and a faded teal neckerchief loose at his throat. His feet are bare and
webbed. His head is uncovered.

He is lean and quick and entirely at his ease: long and narrow through the body, light on his feet,
noticeably taller than he is wide.

Wide, 16:9, three full-body figures at the same scale in a single row, a little headroom above all three.
```

*If the tail comes back short and thick, or he comes back short and round, re-roll. Long, narrow and
tailed is the whole silhouette, and it is the only fast-moving shape in the cast.*
...
An elderly anthropomorphic pig man, heavy and thickset, with a short powerful neck and shoulders set forward
so that his head is carried low and slightly ahead of him. Coarse bristly hide in grizzled iron-grey shot
through with brown, paler and almost white along the jaw. A broad blunt snout, small deep-set dark eyes
under heavy brows, one ear notched through at the top and long healed, and two short worn lower tusks.

He wears a dark moss-green shirt with the sleeves rolled past the elbow, a heavy oiled-leather work apron to
the knee, thick earth-brown canvas trousers, wide scuffed boots, a broad cracked leather belt, and a flat
dark cloth cap pulled low over his eyes.

He is braced rather than settled: weight forward, low and wide through the chest, as though about to lean on
something. Weathered, and in the three-quarter and side views he is looking at something off to one side
rather than at the viewer.

Wide, 16:9, three full-body figures at the same scale in a single row, a little headroom above all three.
```

*Two failure modes to watch. The word for him is **pig man** — if he comes back as a four-legged feral
boar the head noun has drifted (rule 22). And he must not read as Old Ambrose: Ambrose is settled and at
rest, Gus has his weight forward. If you cannot tell them apart from the shoulders alone, say so and the
block gets another pass.*
...
- **Episode 003 illustration slots** — **six, and the prompts are written and waiting** in
  `prompts/ep-003-prompts.md`. One self-contained box per slot. Slot 05 is the repair beat and is the one
  that matters; the calm, dry, chin-level, eyes-lifted language in it is doing the whole job. Files drop
  into `images/ep-003/` under the exact names in that file and nothing on the page needs editing.
- **Bruno and Gus portraits** — `bruno-portrait.png`, `gus-portrait.png`. Only after their sheets are
  approved, and only if a scene wants a close identity anchor.
